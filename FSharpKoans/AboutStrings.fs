...
module ``about strings`` =
    ...
    let FormattingStringValues() =
        ...
        (* TRY IT: What happens if you change 11 to be something besides 
                   a number? *)
        //error FS0001: The type 'string' is not compatible with any of the types 
        //byte,int16,int32,int64,sbyte,uint16,uint32,uint64,nativeint,unativeint, arising from the use of a printf-style format string
